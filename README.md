...
- **Acknowledgments**: 本次改进参考了zhihu.com上Jimmy先生发表的文章《【closerAI ComfyUI】nunchakuV1.1支持z-image+支持zimage-LORA的修复方案，短板一次性补全，nunchaku zimage全面高速生图解决方案！》。在此谨向Jimmy先生致以诚挚谢意。
