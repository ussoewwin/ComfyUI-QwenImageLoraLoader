...
console.log("★★★ zimageturbo_lora_dynamic_v4.js: Z-Image-Turbo LoRA Stack V4 ★★★");
...
app.registerExtension({
    ...
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        if (nodeData.name === "NunchakuZImageTurboLoraStackV4") {
    ...
    nodeCreated(node) {
        ...
        const initCache = () => {
            ...
            if (loraCountWidget) {
                ...
                // Hide V4's lora_count widget using HIDDEN_TAG and computeSize
