...
class NunchakuZImageTurboLoraStackV2:
    ...
    TITLE = "Nunchaku Z-Image-Turbo LoRA Stack V2"
    CATEGORY = "Nunchaku"
    ...
    def load_lora_stack(self, model, lora_count, cpu_offload="disable", **kwargs):
        ...
        if hasattr(model_wrapper, 'model') and hasattr(model_wrapper, 'loras'):
            ...
            # Create wrapper
            logger.info(f"📦 Creating ComfyZImageTurboWrapper with cpu_offload='{cpu_offload}'")
...
GENERATED_NODES = {
    "NunchakuZImageTurboLoraStackV2": NunchakuZImageTurboLoraStackV2
}

GENERATED_DISPLAY_NAMES = {
    "NunchakuZImageTurboLoraStackV2": "Nunchaku Z-Image-Turbo LoRA Stack V2"
}
